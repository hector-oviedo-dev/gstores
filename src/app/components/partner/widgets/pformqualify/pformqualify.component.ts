...
@Component({
  selector: 'app-pformqualify',
  templateUrl: './pformqualify.component.html',
  styleUrls: ['./pformqualify.component.css']
})
export class PformqualifyComponent implements OnInit {
  @Input() UID:string;
